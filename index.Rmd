...
<!-- <br>Slides available at <http://bit.ly/infer-useR><br> -->
<!-- <br>Package webpage at <https://hongyuanjia.github.io/eplusr> -->
...
[`r icon::fa(name = "twitter")` @jiahony](http://twitter.com/jiahony)

[`r icon::fa(name = "github")` @hongyuanjia](http://github.com/hongyuanjia)

[`r icon::fa(name = "envelope")` hongyuan.jia@bears-berkeley.sg](mailto:hongyuan.jia@bears-berkeley.sg)
...
### `r icon::fa("r-project")` &nbsp; You know R and are comfortable with R programming
...
## `r icon::fa("flushed")` &nbsp; Wait! For Reading and Modifying IDF???

## We already have IDF Editor!! Why bother ??
...
# .blue[Life is hard using EnergyPlus, sometimes &nbsp; `r icon::fa("grin-squint-tears")`]

---

## `r icon::fa("frown-open")` &nbsp; Sometimes you wish IDF Editor could do better when you rename an object...
...
## `r icon::fa("frown-open")` &nbsp; Sometimes you failed to recall what magics I did to create all those models...
...
## `r icon::fa("frown-open")` &nbsp; Sometimes you accidently moved or deleted that "important" csv file used by your model...

.center[<img src="figure/external-file.png" width="110%" align="center" />]

---

## `r icon::fa("frown-open")` &nbsp; Sometimes you want **REAL** date and time from EnergyPlus' output...

.center[<img src="figure/datetime.png" width="25%" align="center" />]

---

## `r icon::fa("frown-open")` &nbsp; Sometimes you wish EnergyPlus could sperate key name and output variable for you...

.center[<img src="figure/eplusout.png" width="85%" align="center" />]

---

## `r icon::fa("frown-open")` &nbsp; Sometimes you find it is better to show only the data in specific time...

.center[<img src="figure/excel-line-graph.png" width="95%" align="center" />]

---

## `r icon::fa("frown-open")` &nbsp; Sometmes you don't have enough memory to paste all simulation data into a huge excel file...
...
.blue[\[`r icon::fa("question", size = 2)`\] How can I open an IDF file?]

```{r read-idf, out.lines=10}
...
.blue[\[`r icon::fa("question", size = 2)`\] How does `Group` and `Class` mean?]
...
.blue[\[`r icon::fa("question", size = 2)`\] Where is my IDF?]
...
.blue[\[`r icon::fa("question", size = 2)`\] Is there any `Location and Climate` related thing in my model?]
...
.blue[\[`r icon::fa("question", size = 2)`\] Is there any `Schedule:Constant` object in my model?]
...
.blue[\[`r icon::fa("question", size = 2)`\] How can I get all names of existing groups and classes in my model?]
...
.blue[\[`r icon::fa("question", size = 2)`\] How can I get all names of existing groups and classes defined by EnergyPlus?]
...
.blue[\[`r icon::fa("question", size = 2)`\] How many construction and zones are there in my model?]
...
.blue[\[`r icon::fa("question", size = 2)`\] Every construction and zone should have a name. Can I get them?]
...
.blue[\[`r icon::fa("question", size = 2)`\] I don't think object in class `Version` has a name...]
...
.blue[\[`r icon::fa("question", size = 2)`\] If so, how can I distinguish objects that do not have names?]
...
.blue[\[`r icon::fa("question", size = 2)`\] How can I see if a material is used by other constructions?]
...
.blue[\[`r icon::fa("question", size = 2)`\] How can I see the contents of an object?]
...
.blue[\[`r icon::fa("question", size = 2)`\] What if I want to see all objects in class `Material`?]
...
.blue[\[`r icon::fa("question", size = 2)`\] What if I want to see both a construction and a material?]
...
.blue[\[`r icon::fa("question", size = 2)`\] What if I want to see a material and all constructions that use it?]
...
.blue[\[`r icon::fa("question", size = 2)`\] But those construction may be also used in surfaces. Can I get all objects that has some relations with that material?]
...
.blue[\[`r icon::fa("question", size = 2)`\] But how can I remember all field names?]
...
.blue[\[`r icon::fa("question", size = 2)`\] I don't want to copy from the console!]
...
.blue[\[`r icon::fa("question", size = 2)`\] So I guess there should be other data I can get from `mat_def`...]
...
.blue[\[`r icon::fa("question", size = 2)`\] I love copy-- paste...]
...
.blue[\[`r icon::fa("question", size = 2)`\] You know, R is fameous for `data.frame`...]
...
.blue[\[`r icon::fa("question", size = 2)`\] No one would like to manually create that string or data.frame...]
...
.blue[\[`r icon::fa("question", size = 2)`\] What if I want to directly insert objects from another `Idf`?]
...
.blue[\[`r icon::fa("question", size = 2)`\] What if I want to delete the material and all constructions that use it?]
