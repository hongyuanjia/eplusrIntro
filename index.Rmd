...
[`r fa(name = "twitter")` @jiahony](http://twitter.com/jiahony)

[`r fa(name = "github")` @hongyuanjia](http://github.com/hongyuanjia)

[`r fa(name = "envelope")` hongyuan.jia@bears-berkeley.sg](mailto:hongyuan.jia@bears-berkeley.sg)
...
### `r fa("r-project")` &nbsp; You know R and are comfortable with R programming
...
## `r fa("flushed")` &nbsp; Wait! For Reading and Modifying IDF???

## We already have OpenStudio and IDF Editor!! Why bother ??
...
# .blue[Life is hard using OpenStudio and EnergyPlus, sometimes &nbsp; `r fa("grin-squint-tears")`]
...
(idf <- read_idf(here::here("materials/5ZoneWaterLoopHeatPump.idf")))
```
