...
[`r fa(name = "twitter", fill = blue)` @jiahony](http://twitter.com/jiahony)

[`r fa(name = "github", fill = blue)` @hongyuanjia](http://github.com/hongyuanjia)

[`r fa(name = "envelope", fill = blue)` hongyuan.jia@bears-berkeley.sg](mailto:hongyuan.jia@bears-berkeley.sg)
...
### `r fa("r-project", fill = "white")` &nbsp; You know R and are comfortable with R programming
...
## `r fa("flushed")` &nbsp; Wait! We already have OpenStudio and IDF Editor!!
